        ...
        this.faqItems = [
          {
            ...
            answer: 'Direct ou à travers un partenaire, nos formations sont éligibles aux financements CPF, aux plans de développement des compétences et aux budgets formation entreprise. Nous vous accompagnons dans toutes vos démarches.',
