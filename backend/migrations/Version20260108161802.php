...
final class Version20260108161802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS blog_posts_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS contacts_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS courses_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS exam_vouchers_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS faqs_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS home_banners_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS labs_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS placement_answers_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS placement_questions_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS placement_test_results_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS placement_tests_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS syllabus_modules_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE IF NOT EXISTS testimonials_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS blog_posts (id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, excerpt TEXT DEFAULT NULL, content TEXT NOT NULL, image TEXT DEFAULT NULL, category VARCHAR(100) NOT NULL, author VARCHAR(255) NOT NULL, read_time INT DEFAULT NULL, published BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX IF NOT EXISTS UNIQ_78B2F932989D9B62 ON blog_posts (slug)');
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS exam_vouchers (id INT NOT NULL, code VARCHAR(50) NOT NULL, exam_code VARCHAR(50) NOT NULL, type VARCHAR(50) NOT NULL, price NUMERIC(10, 2) NOT NULL, validity_period INT NOT NULL, description TEXT DEFAULT NULL, booking_steps JSON DEFAULT NULL, reschedule_rules TEXT DEFAULT NULL, redemption_info TEXT DEFAULT NULL, schedule_location TEXT DEFAULT NULL, id_requirements TEXT DEFAULT NULL, is_active BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX IF NOT EXISTS UNIQ_D071487B77153098 ON exam_vouchers (code)');
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS faqs (id INT NOT NULL, question TEXT NOT NULL, answer TEXT NOT NULL, category VARCHAR(100) NOT NULL, order_index INT DEFAULT NULL, published BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS labs (id INT NOT NULL, module_id INT NOT NULL, name VARCHAR(255) NOT NULL, duration VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IF NOT EXISTS IDX_87661F13AFC2B591 ON labs (module_id)');
        $this->addSql('CREATE TABLE IF NOT EXISTS placement_answers (id INT NOT NULL, question_id INT NOT NULL, text TEXT NOT NULL, score NUMERIC(5, 2) NOT NULL, is_correct BOOLEAN NOT NULL, order_index INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IF NOT EXISTS IDX_9F3835A11E27F6BF ON placement_answers (question_id)');
        $this->addSql('CREATE TABLE IF NOT EXISTS placement_questions (id INT NOT NULL, placement_test_id INT NOT NULL, question TEXT NOT NULL, explanation TEXT DEFAULT NULL, order_index INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IF NOT EXISTS IDX_4F2E12B5D1B5F7FE ON placement_questions (placement_test_id)');
        $this->addSql('CREATE TABLE IF NOT EXISTS placement_test_results (id INT NOT NULL, placement_test_id INT NOT NULL, user_email VARCHAR(255) DEFAULT NULL, user_name VARCHAR(255) DEFAULT NULL, score NUMERIC(5, 2) NOT NULL, total_questions INT NOT NULL, correct_answers INT NOT NULL, passed BOOLEAN NOT NULL, answers JSON DEFAULT NULL, completed_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ip_address VARCHAR(45) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IF NOT EXISTS IDX_FEA5808AD1B5F7FE ON placement_test_results (placement_test_id)');
        $this->addSql('CREATE TABLE IF NOT EXISTS placement_tests (id INT NOT NULL, course_id INT NOT NULL, title VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, passing_score INT NOT NULL, time_limit INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_active BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX IF NOT EXISTS UNIQ_1CBCFCED591CC992 ON placement_tests (course_id)');
        $this->addSql('CREATE TABLE IF NOT EXISTS syllabus_modules (id INT NOT NULL, course_id INT NOT NULL, title VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, order_index INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IF NOT EXISTS IDX_5863F4D591CC992 ON syllabus_modules (course_id)');
        $this->addSql('CREATE TABLE IF NOT EXISTS testimonials (id INT NOT NULL, quote TEXT DEFAULT NULL, author VARCHAR(255) DEFAULT NULL, role VARCHAR(255) DEFAULT NULL, company VARCHAR(255) DEFAULT NULL, rating INT DEFAULT NULL, video_url VARCHAR(500) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql("DO \$\$ BEGIN ALTER TABLE labs ADD CONSTRAINT FK_87661F13AFC2B591 FOREIGN KEY (module_id) REFERENCES syllabus_modules (id) NOT DEFERRABLE INITIALLY IMMEDIATE; EXCEPTION WHEN duplicate_object THEN NULL; END \$\$");
        $this->addSql("DO \$\$ BEGIN ALTER TABLE placement_answers ADD CONSTRAINT FK_9F3835A11E27F6BF FOREIGN KEY (question_id) REFERENCES placement_questions (id) NOT DEFERRABLE INITIALLY IMMEDIATE; EXCEPTION WHEN duplicate_object THEN NULL; END \$\$");
        $this->addSql("DO \$\$ BEGIN ALTER TABLE placement_questions ADD CONSTRAINT FK_4F2E12B5D1B5F7FE FOREIGN KEY (placement_test_id) REFERENCES placement_tests (id) NOT DEFERRABLE INITIALLY IMMEDIATE; EXCEPTION WHEN duplicate_object THEN NULL; END \$\$");
        $this->addSql("DO \$\$ BEGIN ALTER TABLE placement_test_results ADD CONSTRAINT FK_FEA5808AD1B5F7FE FOREIGN KEY (placement_test_id) REFERENCES placement_tests (id) NOT DEFERRABLE INITIALLY IMMEDIATE; EXCEPTION WHEN duplicate_object THEN NULL; END \$\$");
        $this->addSql("DO \$\$ BEGIN ALTER TABLE placement_tests ADD CONSTRAINT FK_1CBCFCED591CC992 FOREIGN KEY (course_id) REFERENCES courses (id) NOT DEFERRABLE INITIALLY IMMEDIATE; EXCEPTION WHEN duplicate_object THEN NULL; END \$\$");
        $this->addSql("DO \$\$ BEGIN ALTER TABLE syllabus_modules ADD CONSTRAINT FK_5863F4D591CC992 FOREIGN KEY (course_id) REFERENCES courses (id) NOT DEFERRABLE INITIALLY IMMEDIATE; EXCEPTION WHEN duplicate_object THEN NULL; END \$\$");
        $this->addSql('DROP TABLE IF EXISTS ohm_contracts');
        $this->addSql('ALTER TABLE users DROP CONSTRAINT IF EXISTS fk_1483a5e9b03a8386');
        $this->addSql('DROP INDEX IF EXISTS idx_1483a5e9b03a8386');
        $this->addSql('DROP INDEX IF EXISTS idx_email');
        $this->addSql('DROP INDEX IF EXISTS idx_is_active');
        $this->addSql('DROP INDEX IF EXISTS idx_role');
        $this->addSql("DO \$\$ BEGIN ALTER TABLE users ADD username VARCHAR(100) NOT NULL DEFAULT ''; EXCEPTION WHEN duplicate_column THEN NULL; END \$\$");
        $this->addSql("DO \$\$ BEGIN ALTER TABLE users ADD active BOOLEAN NOT NULL DEFAULT true; EXCEPTION WHEN duplicate_column THEN NULL; END \$\$");
        $this->addSql('ALTER TABLE users DROP COLUMN IF EXISTS created_by_id');
        ...
        $this->addSql('ALTER TABLE users DROP COLUMN IF EXISTS department');
        $this->addSql('ALTER TABLE users DROP COLUMN IF EXISTS is_active');
        $this->addSql('ALTER TABLE users DROP COLUMN IF EXISTS hire_date');
        ...
        $this->addSql('ALTER TABLE users DROP COLUMN IF EXISTS social_security_number');
        $this->addSql('ALTER TABLE users DROP COLUMN IF EXISTS contract_type');
        $this->addSql('ALTER TABLE users DROP COLUMN IF EXISTS base_salary');
        $this->addSql('ALTER TABLE users DROP COLUMN IF EXISTS iban');
        $this->addSql('ALTER TABLE users DROP COLUMN IF EXISTS notes');
        $this->addSql("DO \$\$ BEGIN ALTER TABLE users ALTER created_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE; EXCEPTION WHEN others THEN NULL; END \$\$");
        $this->addSql("DO \$\$ BEGIN ALTER TABLE users ALTER updated_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE; ALTER TABLE users ALTER updated_at DROP NOT NULL; EXCEPTION WHEN others THEN NULL; END \$\$");
