...
final class Version20260507155000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE session_documents_generic ADD CONSTRAINT FK_INTR_DOC_GENERIC_ADMIN FOREIGN KEY (created_by_admin_id) REFERENCES users (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE student_documents ADD CONSTRAINT FK_INTR_STUDENT_DOC_SIGNED_USER FOREIGN KEY (signed_by_user_id) REFERENCES users (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE student_documents ADD CONSTRAINT FK_INTR_STUDENT_DOC_ADMIN FOREIGN KEY (created_by_admin_id) REFERENCES users (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE session_validation_tests ADD CONSTRAINT FK_INTR_VALIDATION_ADMIN FOREIGN KEY (created_by_admin_id) REFERENCES users (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE student_validation_results ADD CONSTRAINT FK_INTR_VALIDATION_RESULT_ADMIN FOREIGN KEY (scored_by_admin_id) REFERENCES users (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
