...
final class Version20260429081500 extends AbstractMigration
{
    ...
    {
        return 'Create intranet base schema (intranet_users, roles, permissions, sessions, news).';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intranet_users (id SERIAL NOT NULL, role_id INT NOT NULL, first_name VARCHAR(120) NOT NULL, last_name VARCHAR(120) NOT NULL, email VARCHAR(180) NOT NULL, password_hash VARCHAR(255) NOT NULL, is_active BOOLEAN NOT NULL DEFAULT TRUE, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1483A5E9E7927C74 ON intranet_users (email)');
        $this->addSql('CREATE INDEX IDX_1483A5E9D60322AC ON intranet_users (role_id)');
        $this->addSql('ALTER TABLE intranet_users ADD CONSTRAINT FK_1483A5E9D60322AC FOREIGN KEY (role_id) REFERENCES roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE news ADD CONSTRAINT FK_5E237E06F675F31B FOREIGN KEY (author_id) REFERENCES intranet_users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE intranet_users DROP CONSTRAINT FK_1483A5E9D60322AC');
        ...
        $this->addSql('DROP TABLE intranet_users');
